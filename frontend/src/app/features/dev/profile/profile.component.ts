...
export class ProfileComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.profileService.update({
      ...
      max_radius_km: data.max_radius_km || undefined,
      salary_clt_min: this.parseCurrency(data.salary_clt_min) ?? undefined,
      salary_clt_max: this.parseCurrency(data.salary_clt_max) ?? undefined,
      salary_pj_min: this.parseCurrency(data.salary_pj_min) ?? undefined,
      salary_pj_max: this.parseCurrency(data.salary_pj_max) ?? undefined,
  ...
  private patchForm(profile: import('../../../core/models/dev-profile.model').DevProfile): void {
    this.form.patchValue({
      ...
      salary_clt_min: profile.salary_clt_min != null ? String(profile.salary_clt_min) : '',
      salary_clt_max: profile.salary_clt_max != null ? String(profile.salary_clt_max) : '',
      salary_pj_min: profile.salary_pj_min != null ? String(profile.salary_pj_min) : '',
      salary_pj_max: profile.salary_pj_max != null ? String(profile.salary_pj_max) : '',
